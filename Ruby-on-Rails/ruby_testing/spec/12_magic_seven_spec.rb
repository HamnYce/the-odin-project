...
describe MagicSeven do
  ...
  describe '#subtract_random_number' do
    context 'when random number is 15 and input is 20' do
      it 'returns 5' do
        magic_seven_instance = MagicSeven.new(15)
        result = magic_seven_instance.subtract_random_number(20)
  ...
  describe '#play' do
    ...
    context 'when the random number is 8' do
      ...
      it 'will return 7' do
        magic_seven_eight = MagicSeven.new(8)
        result = magic_seven_eight.play
    ...
    context 'when the random number is 4' do
      # remove the 'x' before running this test
      it 'will return 7' do
        magic_seven_four = MagicSeven.new(4)
        result = magic_seven_four.play
        expect(result).to eq(7)
      end
    end
    ...
    context 'when the random number is 18' do
      # remove the 'x' before running this test
      it 'will return 7' do
        magic_seven_eighteen = MagicSeven.new(18)
        result = magic_seven_eighteen.play
        expect(result).to eq(7)
      end
    end
  end
